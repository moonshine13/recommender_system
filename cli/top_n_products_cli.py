"""
CLI for user-based recommendations.

This script provides a command-line interface to compute personalized
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--days", type=int, default=365, help="Number of days to analyze"
    )
    parser.add_argument(
        "--min_ratings", type=int, default=10, help="Minimum number of ratings"
    )
    parser.add_argument(
    ...
    try:
        ...
        top_products = top_n_products_run(
            path=args.path, days=args.days, min_ratings=args.min_ratings, n=args.n
        )
